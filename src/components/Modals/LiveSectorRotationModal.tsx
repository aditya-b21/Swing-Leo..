...
import { ArrowLeft, RefreshCw, BarChart3, Lock, CreditCard, CheckCircle } from 'lucide-react';
import { motion } from 'framer-motion';
import { useNavigate } from 'react-router-dom';
import { PaymentModal } from '@/components/Payment/PaymentModal';

interface LiveSectorRotationModalProps {
  onClose: () => void;
}

export const LiveSectorRotationModal: React.FC<LiveSectorRotationModalProps> = ({ onClose }) => {
  ...
  if (!isVerified) {
    ...
    return (
      ...
      >
        ...
        <iframe
          ref={iframeRef}
          src="https://sectorr.onrender.com/"
          className="flex-1 w-full border-none"
          title="Live Sector Rotation"
        />
      </motion.div>
    );
  }
