...
interface LeoAiModalProps {
  // onClose: () => void; // Removed onClose prop
}

export const LeoAiModal: React.FC<LeoAiModalProps> = (/* Removed onClose from destructuring */) => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center p-4 bg-gray-900 shadow-md flex-shrink-0">
        ...
        <h2 className="text-xl font-semibold text-white">LEO AI Chatbot</h2>
        <div className="w-16">{/* Spacer to balance the 'Back' button */}</div>
      </div>
      <iframe
        src="https://leo-the-ai-bot.onrender.com"
