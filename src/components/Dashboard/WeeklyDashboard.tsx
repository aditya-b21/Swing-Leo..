...
export function WeeklyDashboard() {
  ...
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <Card className="bg-white/5 border border-white/10 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
        <CardHeader>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-white/5 border border-white/10 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <Target className="w-8 h-8 text-accent-silver" />
              <div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-gray-400 text-sm">Total Loss</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white/5 border border-white/10 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <DollarSign className="w-8 h-8 text-accent-silver" />
              <div>
                <div className="text-2xl font-bold text-accent-silver">{winRate.toFixed(1)}%</div>
      ...
      <div className="grid lg:grid-cols-2 gap-6 animate-fade-in">
        ...
        {profitLossData.length > 0 && (
          <Card className="bg-white/5 border border-white/10 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardHeader>
      ...
      {/* No data message */}
      {totalTrades === 0 && (
        <Card className="bg-white/5 border border-white/10 rounded-lg shadow-xl">
