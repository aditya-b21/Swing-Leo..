...
export interface StockData {
  ...
  price: number;
  volume: number;
  percentChange?: number;  // Optional percent change field
  uploadDate?: string;  // Date when the stock was uploaded
}

export type SetupType = 'VCP' | 'Rocket' | 'IPO';
